...
# Get token from Railway TOKEN variable first, then fall back to config.json for local testing
TOKEN = os.environ.get("TOKEN") or CONFIG.get("bot_token", "")
...
if __name__ == "__main__":
 if not TOKEN:
 raise RuntimeError("No Discord bot token found. Set TOKEN in Railway or bot_token in config.json for local testing.")
 bot.run(TOKEN)
